...
export default {
    // props:{
    //   EmpDat:this.Employee
    // },
    components:{
    },
    data(){
        return{
            uname:'',pass:'',Employee:'',called:false,
            toshowseccess:false,
            toshowlogin:true,
            toshowfail:false,
    ...
    methods:{    //this.uname,this.pass,this.is_gamil    
        login(){//name,emailid,desc,pass,is_gmail,general,is_fb
          employeedataService.createEmployeeByID("",this.uname,"",this.pass,"gamil").then(response=>{
            this.Employee=response.data;
            router.push({
              path:'/employees',
              query: { employee: this.Employee.email },
              meta:{name:this.Employee.name}
            })
